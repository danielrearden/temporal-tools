...
import { type ActivityOptions, type Duration, type VersioningIntent } from "@temporalio/common";
...
import { ZodVoid, type z, type ZodTuple, type ZodType, ZodUndefined } from "zod";
...
> & {
   ...
   */
  taskQueue?: Extract<keyof TConfig["taskQueues"], string>;
} & (
    | {
        /**
...
> & {
   ...
   */
  taskQueue: keyof TConfig["taskQueues"];
  /**
